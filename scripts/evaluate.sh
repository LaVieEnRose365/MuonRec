...
do
    # your model path 
    # Instruction: Uncomment the corresponding line below to evaluate 
    # either the SFT stage model or the RL stage model.
    # [Eg 1]: Evaluate the SFT model (Muon baseline)
    # exp_name="outputs/generative/sft_muon/${category}/final_checkpoint"
    
    # [Eg 2]: Evaluate the SFT model (Adam baseline)
    # exp_name="outputs/generative/sft_adam/${category}/final_checkpoint"
    
    # [Eg 3]: Evaluate the RL model (Muon baseline)
    # exp_name="outputs/generative/rl_muon/${category}/final_checkpoint"
    
    # --- Set your actual evaluation target here ---
    exp_name="outputs/generative/rl_muon/${category}/final_checkpoint"
    ...
    output_dir="./results/1119/1.5B_sft1${exp_name_clean}"
